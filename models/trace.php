<?php 
function trace($traceAddress=null,$maxHops=4,$maxWait=56){
	if(isset($_REQUEST['traceAddress'])&&!empty($_REQUEST['traceAddress'])){
		$traceAddress=$_REQUEST['traceAddress'];
	}
	if(isset($_REQUEST['maxHops'])&&!empty($_REQUEST['maxHops'])){
		$maxHops=$_REQUEST['maxHops'];
	}
	if(isset($_REQUEST['maxWait'])&&!empty($_REQUEST['maxWait'])){
